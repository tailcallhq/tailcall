...
object Config {
  ...
  object Operation {
    ...
    final case class Transformation(@jsonField("apply") transform: Transform)
        extends Operation
  ...
  implicit lazy val operationCodec: JsonCodec[Operation] = {
    DeriveJsonCodec.gen[Operation]
  }

  implicit lazy val transformCodec: JsonCodec[Transform] = {
    DeriveJsonCodec.gen[Transform]
  }

  implicit lazy val serverCodec: JsonCodec[Server] = {
    DeriveJsonCodec.gen[Server]
  }
  ...
  implicit lazy val connectionCodec: JsonCodec[Connection] = {
  ...
  implicit lazy val configCodec: JsonCodec[Config] = {
    DeriveJsonCodec.gen[Config]
  }
