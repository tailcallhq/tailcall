...
mod tests {
    ...
    fn test_nplusone_resolvers() {
        let config = Config::default().query("Query").types(vec![
            ...
            Type::new("F2").fields(vec![("f3", Field::default().type_of("String".to_string()))]),
        ]);
    ...
    fn test_nplusone_nested_resolvers() {
        let config = Config::default().query("Query").types(vec![
            ...
            Type::new("F2").fields(vec![(
                "f3",
                Field::default().type_of("F3".to_string()).into_list(),
            )]),
            Type::new("F3").fields(vec![(
                "f4",
                Field::default()
    ...
    fn test_nplusone_nested_non_list() {
        ...
        let config = Config::default().query("Query").types(vec![
            Type::new("Query").fields(vec![("f", f_field)]),
            Type::new("F").fields(vec![(
                "g",
                Field::default()
                    .type_of("G".to_string())
                    .into_list()
            ...
            Type::new("G").fields(vec![("e", Field::default().type_of("String".to_string()))]),
        ]);
