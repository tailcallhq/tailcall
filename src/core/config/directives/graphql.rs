...
pub struct GraphQL {
    ...
    /// no further subfields will be returned. This helps to limit the
    /// complexity and size of the query results. If this value is not set,
    /// the default depth is 5, ensuring that queries are manageable and
