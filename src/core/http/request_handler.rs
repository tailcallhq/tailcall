        ...
        "nestedObjects": [
            {
                "deeplyNestedObjects": [
                    {
                        "aFieldOnDeeplyNestedObject": "a field on deeply nested object - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                        "bFieldOnDeeplyNestedObject": 1,
                        "cFieldOnDeeplyNestedObject": true,
                        "dFieldOnDeeplyNestedObject": 2.0,
                        "eFieldOnDeeplyNestedObject": "e field on deeply nested object - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                        "fFieldOnDeeplyNestedObject": 3,
                        "gFieldOnDeeplyNestedObject": false,
                        "hFieldOnDeeplyNestedObject": 4.0,
                        "iFieldOnDeeplyNestedObject": "i field on deeply nested object - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                        "jFieldOnDeeplyNestedObject": 5,
                        "kFieldOnDeeplyNestedObject": true,
                        "lFieldOnDeeplyNestedObject": 6.0,
                        "mFieldOnDeeplyNestedObject": "m field on deeply nested object - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                        "nFieldOnDeeplyNestedObject": 7,
                        "oFieldOnDeeplyNestedObject": false,
                        "pFieldOnDeeplyNestedObject": 8.0,
                        "qFieldOnDeeplyNestedObject": "q field on deeply nested object - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                        "rFieldOnDeeplyNestedObject": 9,
                        "sFieldOnDeeplyNestedObject": true,
                        "tFieldOnDeeplyNestedObject": 10.0,
                        "uFieldOnDeeplyNestedObject": "u field on deeply nested object - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                        "vFieldOnDeeplyNestedObject": 11,
                        "wFieldOnDeeplyNestedObject": false,
                        "xFieldOnDeeplyNestedObject": 12.0,
                        "yFieldOnDeeplyNestedObject": "y field on deeply nested object - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
...
async fn handle_request_inner<T: DeserializeOwned + GraphQLRequestLike>(
    ...
    match *req.method() {
        ...
        Method::GET if req.uri().path() == "/big-json" => {
            let status_response = Response::builder()
                .status(StatusCode::OK)
                .header(CONTENT_TYPE, "application/json")
                .body(Body::from(DATA))?;
