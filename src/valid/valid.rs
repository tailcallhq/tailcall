...
impl<A, E: std::cmp::Ord> Valid<A, E> {
...
impl<A, E: std::cmp::Ord> Validator<A, E> for Valid<A, E> {
    fn to_result(self) -> Result<A, ValidationError<E>> {
        self.0
    }
...
impl<A, E: std::cmp::Ord> Validator<A, E> for Fusion<A, E> {
    fn to_result(self) -> Result<A, ValidationError<E>> {
        self.0.to_result()
    }
    fn is_succeed(&self) -> bool {
...
impl<A, E: std::cmp::Ord> From<Result<A, ValidationError<E>>> for Valid<A, E> {
...
impl<A, E: std::cmp::Ord> From<Fusion<A, E>> for Valid<A, E> {
