pub trait Append<A> {
    type Out;
    fn fuse(self, a: A) -> Self::Out;
}

impl<A0, A1> Append<A1> for (A0,) {
    type Out = (A0, A1);
    fn fuse(self, a1: A1) -> Self::Out {
        let (a0,) = self;
        (a0, a1)
    }
}
