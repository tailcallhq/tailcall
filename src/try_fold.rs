...
pub struct TryFold<'a, I: 'a, O: 'a, E: 'a + std::cmp::Ord>(TryFoldFn<'a, I, O, E>);

impl<'a, I, O: Clone + 'a, E: std::cmp::Ord> TryFold<'a, I, O, E> {
...
impl<'a, I, O: Clone, E: std::cmp::Ord> FromIterator<TryFold<'a, I, O, E>>
    for TryFold<'a, I, O, E>
{
