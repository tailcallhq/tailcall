...
type Query {
  ...
  mean: Int @expr(body: {mean: [{const: 45}, {const: 39}]})
  median: Int @expr(body: {median: [{const: 1}, {const: 42}, {const: 100}]})
}
```
...
- method: POST
  ...
  body:
    query: query { add subtract multiply mod div1 div2 inc dec product sum mean median }
```
